...
class DormitoryDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $gtkUsers     = User::whereHas('roles', fn($q) => $q->where('name', 'GTK'))->get();
        ...
        foreach ($santriPerLevel as $gradeLevel => $count) {
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                // Class history
                if ($sg) $this->classHistory($student, $sg);
        ...
        foreach ($moveCandidates as $studentId) {
            ...
            if ($targetRooms->isEmpty()) continue;
        ...
        $itemTemplates = [
            ...
            ['name' => 'Lampu Tidur', 'condition' => 'rusak_ringan'],
            ['name' => 'Stop Kontak', 'condition' => 'baik'],
            ['name' => 'Kipas Angin', 'condition' => 'rusak_ringan'],
            ['name' => 'Al-Quran', 'condition' => 'baik'],
            ['name' => 'Mukena', 'condition' => 'baik'],
            ['name' => 'Sarung', 'condition' => 'baik'],
            ['name' => 'Tempat Wudhu', 'condition' => 'rusak_ringan'],
            ['name' => 'Cermin', 'condition' => 'baik'],
            ['name' => 'Gantungan Baju', 'condition' => 'baik'],
            ['name' => 'Tempat Sampah', 'condition' => 'rusak_berat'],
            ['name' => 'Talang Air', 'condition' => 'rusak_ringan'],
