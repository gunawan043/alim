...
class KesejahteraanKlaim extends Model
{
    ...
    public function kesejahteraan(): BelongsTo { return $this->belongsTo(Kesejahteraan::class); }
    public function processor(): BelongsTo { return $this->belongsTo(User::class, 'diproses_oleh'); }
}
