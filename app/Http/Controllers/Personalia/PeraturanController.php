...
class PeraturanController extends Controller
{
    ...
    {
        return view('personalia.peraturan.index', compact('userId'));
    }

    public function create(Request $request, string $userId)
    {
        return view('personalia.peraturan.create', compact('userId'));
    }

    public function store(Request $request, string $userId)
    {
        // TODO: Implement store logic
        return redirect()->back()->with('success', 'Peraturan berhasil disimpan.');
    }

    public function edit(Request $request, string $userId, string $id)
    {
        return view('personalia.peraturan.edit', compact('userId', 'id'));
    }
    ...
    {
        return view('personalia.peraturan.kategori', compact('userId'));
    }

    public function violation(Request $request, string $userId)
    {
        return view('personalia.peraturan.violation', compact('userId'));
    }
