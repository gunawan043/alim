...
<div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <div class="d-flex flex-column flex-column-fluid pt-10">
        <div class="toolbar px-6 py-2 d-flex justify-content-between align-items-center">
            <div>
                <h3 class="fs-4 fw-bold text-dark mb-0">Rekap Tahunan GTK</h3>
                <span class="text-muted fs-7">Rekapitulasi penilaian GTK sepanjang tahun ajaran</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center text-muted py-10">
                        <i class="ri-bar-chart-box-line" style="font-size: 3rem;"></i>
