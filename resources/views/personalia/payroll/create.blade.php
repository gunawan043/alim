{{-- Payroll: Create — Form Tambah Slip Gaji --}}
...
@component('components.breadcrumb')
    ...
    @slot('li_2') Tambah Gaji @endslot
    @slot('title') Tambah Gaji @endslot
@endcomponent

<div class="page-header-card d-flex justify-content-between align-items-center mb-4">
    <div>
        <h5 class="fw-semibold mb-1">Tambah Gaji GTK</h5>
        <p class="text-muted mb-0" style="font-size:.85rem">Buat record slip gaji baru untuk GTK.</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <h5 class="card-title mb-0"><i class="ri-add-circle-line text-warning me-1"></i> Form Tambah Gaji GTK</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('user.payroll.store', $userId) }}" method="POST">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                    ...
                    <div class="d-flex gap-2 justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-warning btn-sm"><i class="ri-save-line me-1"></i> Simpan Gaji</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-center text-muted py-4">
                    ...
                    <p class="mt-2 mb-1 text-muted" style="font-size:.8rem">Pilih GTK untuk melihat ringkasan gaji terkini.</p>
                </div>
            </div>
        </div>
        <div class="card mt-3">
            <div class="card-header border-bottom-dashed">
                <h5 class="card-title mb-0"><i class="ri-help-line me-1"></i> Petunjuk</h5>
            </div>
            <div class="card-body">
                <ul class="list-unstyled mb-0 small text-muted">
                    <li class="mb-2"><i class="ri-checkbox-circle-line text-success me-1"></i> Isi data GTK dan periode terlebih dahulu</li>
                    <li class="mb-2"><i class="ri-checkbox-circle-line text-success me-1"></i> Masukkan komponen tunjangan sesuai ketentuan</li>
                    <li class="mb-2"><i class="ri-checkbox-circle-line text-success me-1"></i> Masukkan komponen potongan yang berlaku</li>
                    <li class="mb-0"><i class="ri-checkbox-circle-line text-success me-1"></i> Gaji bersih dihitung secara otomatis</li>
                </ul>
            </div>
        </div>
    </div>
