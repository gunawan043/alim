{{-- Payroll: Tunjangan — Daftar Tunjangan GTK --}}
@extends('layouts.master')
@section('title') Tunjangan GTK @endsection
...
@component('components.breadcrumb')
    ...
    @slot('li_2') Tunjangan @endslot
    @slot('title') Tunjangan GTK @endslot
@endcomponent

<div class="page-header-card d-flex justify-content-between align-items-center mb-4">
    <div>
        <h5 class="fw-semibold mb-1">Tunjangan GTK</h5>
        <p class="text-muted mb-0" style="font-size:.85rem">Kelola komponen tunjangan dan benefit GTK.</p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('user.payroll.potongan', $userId) }}" class="btn btn-outline-secondary btn-sm"><i class="ri-subtract-line me-1"></i>Potongan</a>
            ...
            <div class="card-body py-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                    <div class="avatar-sm flex-shrink-0">
                        <span class="avatar-title bg-warning-subtle rounded fs-2"><i class="ri-gift-line text-warning"></i></span>
                    </div>
                    <div>
                        <p class="text-uppercase fw-medium text-muted mb-0" style="font-size:11px;">Total Tunjangan</p>
                        <h3 class="fw-bold ff-secondary mb-0">{{ $totalTunjangan ?? 0 }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card stat-card h-100">
            <div class="card-body py-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <div>
                        <p class="text-uppercase fw-medium text-muted mb-0" style="font-size:11px;">Tunjangan Tetap</p>
                        <h3 class="fw-bold ff-secondary mb-0">{{ $tunjanganTetap ?? 0 }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card stat-card h-100">
            <div class="card-body py-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <div>
                        <p class="text-uppercase fw-medium text-muted mb-0" style="font-size:11px;">Tunjangan Variabel</p>
                        <h3 class="fw-bold ff-secondary mb-0">{{ $tunjanganVariabel ?? 0 }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card stat-card h-100">
            <div class="card-body py-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <div>
                        <p class="text-uppercase fw-medium text-muted mb-0" style="font-size:11px;">Total Nilai</p>
                        <h3 class="fw-bold ff-secondary mb-0">Rp {{ number_format($totalNilai ?? 0, 0, ',', '.') }}</h3>
                    </div>
                </div>
            </div>
        </div>
...
<div class="card">
    <div class="card-header border-bottom-dashed d-flex flex-wrap align-items-center justify-content-between gap-2">
        <h5 class="card-title mb-0"><i class="ri-list-check text-warning me-1"></i> Daftar Tunjangan GTK</h5>
