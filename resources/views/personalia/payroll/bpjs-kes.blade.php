{{-- Payroll: BPJS Kesehatan — Daftar Iuran BPJS Kesehatan --}}
@extends('layouts.master')
@section('title') BPJS Kesehatan @endsection
...
@component('components.breadcrumb')
    ...
    @slot('li_2') BPJS Kesehatan @endslot
    @slot('title') BPJS Kesehatan @endslot
@endcomponent

<div class="page-header-card d-flex justify-content-between align-items-center mb-4">
    <div>
        <h5 class="fw-semibold mb-1">BPJS Kesehatan</h5>
        <p class="text-muted mb-0" style="font-size:.85rem">Data iuran BPJS Kesehatan GTK.</p>
    </div>
...
<div class="card">
    <div class="card-header border-bottom-dashed d-flex flex-wrap align-items-center justify-content-between gap-2">
        <h5 class="card-title mb-0"><i class="ri-list-check text-warning me-1"></i> Daftar Iuran BPJS Kesehatan</h5>
        <div class="d-flex gap-2">
