                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="hstack gap-3 flex-wrap">
                                        <div class="text-muted"><i class="ri-building-line align-bottom me-1"></i><span id="ticket-client">friday</span></div>
                                        <div class="vr"></div>
                    ...
                    <table class="table table-borderless align-middle mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="t-client">friday</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Project</td>
                                <td>Alim - Admin Dashboard</td>
                            </tr>
                            <tr>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center border border-dashed p-2 rounded">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1"><a href="javascript:void(0);">Alim-admin.zip</a></h6>
                ...
                <div class="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1"><a href="javascript:void(0);">Alim-admin.ppt</a></h6>
