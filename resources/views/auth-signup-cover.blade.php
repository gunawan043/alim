                                            ...
                                            <div class="position-relative h-100 d-flex flex-column">
                                                <div class="mb-4">
                                                    <a href="index" class="d-block">
                                                        <img src="{{ URL::asset('build/images/alim-light-name.png') }}" alt="" height="18">
                                                    </a>
                                                </div>
                                                <div class="mt-auto">
                                                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0">&copy; <script>document.write(new Date().getFullYear())</script> Alim. Crafted with <i class="mdi mdi-heart text-danger"></i> by friday</p>
                            </div>
                        </div>
                    </div>
                </div>
