                    ...
                    <div class="table-responsive table-card mb-1">
                        ...
                        <div class="noresult" style="display: none">
                            <div class="text-center">
                                <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#005981,secondary:#0ab39c" style="width:75px;height:75px">
                                </lord-icon>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body p-5 text-center">
                                <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop" colors="primary:#005981,secondary:#f06548" style="width:90px;height:90px">
                                </lord-icon>
