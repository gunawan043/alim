        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="index">
                    <img src="{{URL::asset('build/images/alim-dark-name.png')}}" class="card-logo card-logo-dark" alt="logo dark" height="17">
                    <img src="{{URL::asset('build/images/alim-light-name.png')}}" class="card-logo card-logo-light" alt="logo light" height="17">
                </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 product-item artwork music games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="https://img.friday.com/Alim/images/img-4.gif" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    ...
                                                    <img src="https://img.friday.com/Alim/images/img-2.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-6">
                                                    <img src="https://img.friday.com/Alim/images/img-5.gif" alt="" class="img-fluid rounded mb-1">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    ...
                                                    <img src="https://img.friday.com/Alim/images/img-1.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-6">
                                                    <img src="https://img.friday.com/Alim/images/img-4.gif" alt="" class="img-fluid rounded mb-1">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    ...
                                                    <img src="https://img.friday.com/Alim/images/img-3.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-6">
                                                    <img src="https://img.friday.com/Alim/images/img-1.gif" alt="" class="img-fluid rounded mb-1">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" class="img-fluid rounded">
                                                    <img src="https://img.friday.com/Alim/images/img-5.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-6">
                                                    <img src="https://img.friday.com/Alim/images/img-2.gif" alt="" class="img-fluid rounded mb-1">
                                                    <img src="{{URL::asset('build/images/nft/img-05.jpg')}}" alt="" class="img-fluid rounded">
                                                </div>
                                                <!--end col-->
                                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="https://img.friday.com/Alim/images/img-1.gif" alt="" class="img-fluid explore-img">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="https://img.friday.com/Alim/images/img-5.gif" alt="" class="avatar-sm object-fit-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="pages-profile">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mt-4">
                        <div>
                            <div>
                                <img src="{{URL::asset('build/images/alim-light-name.png')}}" alt="logo light" height="17">
                            </div>
                            <div class="mt-4 fs-14">
                                <p>Alim - Academic Learning & Information Management</p>
                                <p>You can build any type of web application like eCommerce, CRM, CMS, Project management apps, Admin Panels, etc using Alim.</p>
                            </div>
                        </div>
                    </div>
