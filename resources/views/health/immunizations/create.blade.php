...
@section('content')
    ...
    <form method="POST" action="{{ route('user.uks.immunizations.store', ['userId' => $userId]) }}">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header bg-light"><h5 class="mb-0">Form Imunisasi</h5></div>
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="immunization_type" class="form-control @error('immunization_type') is-invalid @enderror" required>
                                        ...
                                        @foreach(['BCG','Polio_1','Polio_2','Polio_3','Polio_4','DPT_HB_Hib_1','DPT_HB_Hib_2','DPT_HB_Hib_3','Campak_MR','MR_2','Hepatitis_B','TT_1','TT_2','TT_3','TT_4','TT_5','Covid19','Influenza','Japanese_Encephalitis','lainnya'] as $type)
                                            <option value="{{ $type }}" {{ old('immunization_type') == $type ? 'selected' : '' }}>
                                                {{ str_replace('_', ' ', $type) }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Nama Vaksin (jika lain)</label>
                                    <input type="text" name="vaccine_name" class="form-control" value="{{ old('vaccine_name') }}" placeholder="Contoh: Vaccine X">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date_given" class="form-control @error('date_given') is-invalid @enderror" value="{{ old('date_given', now()->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="age_at_vaccination_days" class="form-control" value="{{ old('age_at_vaccination_days') }}" placeholder="Contoh: 90">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Tempat</label>
                                    <input type="text" name="place" class="form-control" value="{{ old('place') }}" placeholder="Puskesmas, RS, dll">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Petugas Medis</label>
                                    <input type="text" name="medical_staff" class="form-control" value="{{ old('medical_staff') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="side_effects" class="form-control" rows="2" placeholder="Demam, bengkak, dll">{{ old('side_effects') }}</textarea>
                        </div>
