        ...
        <div class="card" id="contactList">
            <div class="card-header">
                <div class="d-flex align-items center">
                    <h5 class="card-title mb-0 flex-grow-1">The Top NFTs Ranking On Alim</h5>
                ...
                <div class="table-responsive table-card">
                    <table class="table align-middle table-nowrap table-hover" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.friday.com/Alim/images/img-1.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Patterns Arts & Culture</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.friday.com/Alim/images/img-2.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Long-tailed Macaque</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.friday.com/Alim/images/img-5.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">The Chirstoper</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.friday.com/Alim/images/img-3.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Walking On Air</a>
                                    </div>
                                </td>
                    ...
                    <div class="noresult" style="display: none">
                        <div class="text-center">
                            <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#005981,secondary:#0ab39c" style="width:75px;height:75px"></lord-icon>
