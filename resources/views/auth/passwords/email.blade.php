                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted">Lupa Passwords</p>
                                ...
                                <div class="alert alert-borderless alert-warning text-center mb-2 mx-2" role="alert">
                                    Masukan email yang terdaftar untuk mendapatkan kode
                                </div>
                                <div class="p-2">
                                    @if (session('status'))
                                    ...
                                    @endif
                                    <form class="form-horizontal" method="POST" action="{{ route('password.emailsend') }}">
                                        @csrf
                                        <div class="mb-3">
