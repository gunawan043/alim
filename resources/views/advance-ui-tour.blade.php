                            ...
                            <div class="col-lg-5">
                                <div class="text-center mt-4 mb-5">
                                    <div class="py-3 px-2 d-inline-block" id="logo-tour">
                                        <img src="{{ URL::asset('build/images/alim-dark-name.png') }}" class="card-logo card-logo-dark" alt="logo"
                                            height="17">
                                        <img src="{{ URL::asset('build/images/alim-light-name.png') }}" class="card-logo card-logo-light" alt="logo"
                                            height="17">
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card border shadow-none">
                                            <div class="card-body text-center">
                                                ...
                                                <h5>Free register</h5>
                                                <p class="text-muted mb-0">Get your Free Alim account now.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
                                    <div class="col-lg-4">
                                        <div class="card border shadow-none">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted mb-0">Sign in to continue to Alim.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
