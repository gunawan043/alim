                        ...
                        <div class="row mb-3">
                            <div class="col-md">
                                <div class="row align-items-center g-3">
                                    ...
                                    <div class="col-md">
                                        <div>
                                            <h4 class="fw-bold">Alim - Admin & Dashboard</h4>
                                            <div class="hstack gap-3 flex-wrap">
                                                <div><i class="ri-building-line align-bottom me-1"></i> friday</div>
                                                <div class="vr"></div>
                                                ...
                                                <div class="col-xxl-4 col-lg-6">
                                                    <div class="border rounded border-dashed p-2">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <h5 class="fs-14 mb-1"><a href="#"
                                                                        class="text-body text-truncate d-block">Alim
                                                                        admin.ppt</a></h5>
                                                                <div>2.4MB</div>
                                                            </div>
                                                            <div class="flex-shrink-0 ms-2">
                                    ...
                                    <div class="vstack gap-2">
                                        ...
                                        <div class="border rounded border-dashed p-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="fs-15 mb-1"><a href="#"
                                                            class="text-body text-truncate d-block">Alim-admin.ppt</a>
                                                    </h5>
                                                    <div>2.4MB</div>
                                                </div>
                                                <div class="flex-shrink-0 ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3 flex-grow-1">
                                                                <h5 class="fs-14 mb-0"><a href="javascript:void(0);"
                                                                        class="text-body">Alim-logo.png</a></h5>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>PNG File</td>
                            ...
                            <div class="acitivity-timeline py-3">
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted mb-2">added a new member to Alim dashboard</p>
