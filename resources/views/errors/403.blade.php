    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-icon {
            ...
            width: 88px;
            height: 88px;
            background: rgba(0, 89, 129, 0.15);
            border: 1.5px solid rgba(0, 89, 129, 0.4);
            border-radius: 24px;
...
<body>
    ...
    <div class="container">
        ...
        <p class="error-desc">Anda tidak memiliki hak akses yang diperlukan untuk membuka halaman ini.</p>

        <div class="reasons">
            <div class="reasons-header"><i class="ri-information-line"></i> Kemungkinan Penyebab</div>
            <ul>
                <li><i class="ri-checkbox-circle-line"></i> Role akun Anda tidak memiliki akses ke menu ini</li>
                <li><i class="ri-checkbox-circle-line"></i> Akun Anda belum diverifikasi oleh Personalia</li>
                <li><i class="ri-checkbox-circle-line"></i> Session login telah berakhir atau berubah</li>
            </ul>
        </div>

        <div class="actions">
            <a href="{{ url('/') }}" class="btn btn-primary"><i class="ri-home-4-line"></i> Beranda</a>
            <a href="javascript:history.back()" class="btn btn-outline"><i class="ri-arrow-left-line"></i> Kembali</a>
