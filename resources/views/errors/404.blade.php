...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan | ALIM</title>
...
<body>
    ...
    <div class="container">
        ...
        <p class="error-desc">Halaman yang Anda cari tidak tersedia atau telah dipindahkan.</p>

        <div class="reasons">
            <div class="reasons-header"><i class="ri-information-line"></i> Yang Bisa Anda Lakukan</div>
            <ul>
                <li><i class="ri-checkbox-circle-line"></i> Periksa kembali URL yang Anda masukkan</li>
                <li><i class="ri-checkbox-circle-line"></i> Gunakan menu navigasi untuk menemukan halaman</li>
                <li><i class="ri-checkbox-circle-line"></i> Kembali ke beranda dan cari dari sana</li>
            </ul>
        </div>
