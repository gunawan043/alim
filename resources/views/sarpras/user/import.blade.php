...
@php
    $isForcedRoom = isset($forcedRoom) && $forcedRoom;
    $formAction = $isForcedRoom
        ? route('sarpras.user.aset.import.room.process', ['userId' => $userId, 'roomId' => $forcedRoom->id])
        : route('sarpras.user.aset.import.process', ['userId' => $userId]);
    $templateHref = $isForcedRoom
        ? route('sarpras.user.aset.import.room.template', ['userId' => $userId, 'roomId' => $forcedRoom->id])
        : route('sarpras.user.aset.import.template', ['userId' => $userId]);
    $backHref = route('sarpras.user.dashboard', ['userId' => $userId]);
@endphp
    ...
    <div class="col-lg-8">
        ...
        <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="ri-upload-cloud-2-line me-1"></i> Upload File Excel</h5>
            ...
            <div class="card-body">
                <form method="POST" action="{{ $formAction }}"
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ $backHref }}" class="btn btn-light">Batal</a>
        ...
        {{-- Instructions Card --}}
        <div class="card">
            <div class="card-header"><h5 class="mb-0"><i class="ri-book-open-line me-1"></i> Panduan Import Aset</h5></div>
            <div class="card-body">
                <div class="mb-3">
                    <a href="{{ $templateHref }}" class="btn btn-outline-primary">
                    ...
                    <table class="table table-bordered table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-danger">Ya</span></td>
                                <td>Nama atau kode ruang (exact/partial match)</td>
                                <td>Kelas 10 X-A / RG-ABC123</td>
                            </tr>
                            @else
                            <tr>
                                <td><code>ruang</code></td>
                                <td><span class="badge bg-secondary">Tidak</span></td>
                                <td>Diisi otomatis — tidak perlu diisi</td>
                                <td><em class="text-muted">Diisi otomatis</em></td>
                            </tr>
                            @endif
                            <tr>
    ...
    <div class="col-lg-4">
        @if($isForcedRoom)
            <div class="card border-primary">
                <div class="card-header bg-primary-subtle"><h5 class="mb-0 text-primary"><i class="ri-door-open-line me-1"></i>Ruang Tujuan</h5></div>
                <div class="card-body">
                    <div class="fw-bold fs-5">{{ $forcedRoom->room_name }}</div>
                    @if($forcedRoom->room_code)
                        <div class="text-muted"><code>{{ $forcedRoom->room_code }}</code></div>
                    @endif
                    <div class="mt-2">
        ...
        @else
            <div class="card">
                <div class="card-header"><h5 class="mb-0"><i class="ri-door-open-line me-1"></i> Ruangan Tersedia</h5></div>
        ...
        <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="ri-folder-line me-1"></i> Kategori Tersedia</h5>
