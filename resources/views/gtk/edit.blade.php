...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Edit Data GTK @endslot
    @endcomponent

    @php
        $alamatDomisili = $gtk->gtkProfile?->addresses?->where('type','domisili')->first();
        $alamatKtp      = $gtk->gtkProfile?->addresses?->where('type','ktp')->first();
    @endphp
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title mb-0">Edit Data GTK</h4>
                            <small class="text-muted">{{ $gtk->name }} · {{ $gtk->employment?->nupy ?? '-' }}</small>
                        </div>
                    </div>
                    <div class="mt-3">
                ...
                <div class="card-body form-steps">
                    <form id="gtkWizardForm" class="vertical-navs-step" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="_gtk_id" value="{{ $gtk->id }}">
                                ...
                                <div class="px-lg-4">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-data-dasar"
                                            ...
                                            <div>
                                                <h5>Data Dasar</h5>
                                                <p class="text-muted">Edit data pribadi GTK</p>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="nik" name="nik"
                                                           ...
                                                           value="{{ old('nik', $gtk->gtkProfile?->nik) }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="no_kk" name="no_kk"
                                                           ...
                                                           value="{{ old('no_kk', $gtk->gtkProfile?->no_kk) }}">
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="tempat_lahir"
                                                           ...
                                                           value="{{ old('tempat_lahir', $gtk->gtkProfile?->tempat_lahir) }}">
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="tanggal_lahir"
                                                           ...
                                                           value="{{ old('tanggal_lahir', $gtk->gtkProfile?->tanggal_lahir ? \Carbon\Carbon::parse($gtk->gtkProfile->tanggal_lahir)->format('Y-m-d') : '') }}">
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="jenis_kelamin" name="jenis_kelamin" required>
                                                        ...
                                                        <option value="L" {{ old('jenis_kelamin', $gtk->gtkProfile?->jenis_kelamin) == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                                        <option value="P" {{ old('jenis_kelamin', $gtk->gtkProfile?->jenis_kelamin) == 'P' ? 'selected' : '' }}>Perempuan</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="golongan_darah" name="golongan_darah">
                                                        ...
                                                        @foreach(['A','B','AB','O'] as $gd)
                                                            <option value="{{ $gd }}" {{ old('golongan_darah', $gtk->gtkProfile?->golongan_darah) == $gd ? 'selected' : '' }}>{{ $gd }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="agama" name="agama">
                                                        ...
                                                        @foreach(['islam','kristen','katolik','hindu','buddha','konghucu'] as $ag)
                                                            <option value="{{ $ag }}" {{ old('agama', $gtk->gtkProfile?->agama) == $ag ? 'selected' : '' }}>{{ ucfirst($ag) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_ibu_kandung"
                                                           ...
                                                           value="{{ old('nama_ibu_kandung', $gtk->gtkProfile?->nama_ibu_kandung) }}">
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="npwp"
                                                           ...
                                                           value="{{ old('npwp', $gtk->gtkProfile?->npwp) }}">
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-alamat" role="tabpanel">
                                            ...
                                            <div>
                                                <h5>Alamat</h5>
                                                <p class="text-muted">Edit data alamat domisili dan KTP</p>
                                            </div>
                                                ...
                                                <div class="row g-3">
                                                        ...
                                                        <select class="form-select" id="provinsi_domisili"
                                                            ...
                                                            @foreach ($provinces as $province)
                                                                <option value="{{ $province->code }}"
                                                                    {{ old('alamat_domisili.province_code', $alamatDomisili?->province_code) == $province->code ? 'selected' : '' }}>
                                                                    {{ $province->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control" id="jalan_domisili"
                                                               ...
                                                               value="{{ old('alamat_domisili.jalan', $alamatDomisili?->jalan) }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" id="rt_rw_domisili"
                                                               ...
                                                               value="{{ old('alamat_domisili.rt_rw', $alamatDomisili?->rt_rw) }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" id="dusun_domisili"
                                                               ...
                                                               value="{{ old('alamat_domisili.dusun', $alamatDomisili?->dusun) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="kode_pos_domisili"
                                                                   ...
                                                                   value="{{ old('alamat_domisili.kode_pos', $alamatDomisili?->kode_pos) }}">
                                                            <button class="btn btn-outline-secondary" type="button"
                                                                    onclick="document.getElementById('kode_pos_domisili').value=''">
                                                                <i class="ri-delete-bin-line"></i>
                                                            </button>
                                                        </div>
                                                        <small class="text-muted">Terisi otomatis jika data tersedia</small>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-select" id="provinsi_ktp"
                                                            ...
                                                            @foreach ($provinces as $province)
                                                                <option value="{{ $province->code }}"
                                                                    {{ old('alamat_ktp.province_code', $alamatKtp?->province_code) == $province->code ? 'selected' : '' }}>
                                                                    {{ $province->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control" id="jalan_ktp"
                                                               ...
                                                               value="{{ old('alamat_ktp.jalan', $alamatKtp?->jalan) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" id="rt_rw_ktp"
                                                               ...
                                                               value="{{ old('alamat_ktp.rt_rw', $alamatKtp?->rt_rw) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" id="dusun_ktp"
                                                               ...
                                                               value="{{ old('alamat_ktp.dusun', $alamatKtp?->dusun) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="kode_pos_ktp"
                                                                   ...
                                                                   placeholder="Auto / isi manual"
                                                                   value="{{ old('alamat_ktp.kode_pos', $alamatKtp?->kode_pos) }}">
                                                            <button class="btn btn-outline-secondary" type="button"
                                        ...
                                        <div class="tab-pane fade" id="v-pills-pendidikan" role="tabpanel">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <div>
                                                    ...
                                                    <p class="text-muted">Kelola riwayat pendidikan GTK</p>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-kontak" role="tabpanel">
                                            <div>
                                                <h5>Kontak</h5>
                                                <p class="text-muted">Edit informasi kontak GTK</p>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="no_hp"
                                                           ...
                                                           value="{{ old('kontak.no_hp', $gtk->gtkContact?->no_hp) }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="no_whatsapp"
                                                           ...
                                                           value="{{ old('kontak.no_whatsapp', $gtk->gtkContact?->no_whatsapp) }}">
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" id="kontak_darurat"
                                                           ...
                                                           value="{{ old('kontak.kontak_darurat', $gtk->gtkContact?->kontak_darurat) }}">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="instagram"
                                                               ...
                                                               value="{{ old('kontak.instagram', $gtk->gtkContact?->instagram) }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="facebook"
                                                           ...
                                                           value="{{ old('kontak.facebook', $gtk->gtkContact?->facebook) }}">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="twitter"
                                                               ...
                                                               value="{{ old('kontak.twitter', $gtk->gtkContact?->twitter) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-kepegawaian" role="tabpanel">
                                            <div>
                                                ...
                                                <p class="text-muted">Edit data kepegawaian GTK</p>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="nupy"
                                                           ...
                                                           value="{{ old('kepegawaian.nupy', $gtk->employment?->nupy) }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="jenis_gtk"
                                                        ...
                                                        @foreach($jenisGtk as $jg)
                                                            <option value="{{ $jg->id }}"
                                                                {{ old('kepegawaian.jenis_gtk', $gtk->employment?->jenis_gtk_id) == $jg->id ? 'selected' : '' }}>
                                                                {{ $jg->nama }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="status_kepegawaian"
                                                        ...
                                                        <option value="">Pilih...</option>
                                                        @foreach(['PTT'=>'Pegawai Tidak Tetap','PTY'=>'Pegawai Tetap Yayasan','GTT'=>'Guru Tidak Tetap','GTY'=>'Guru Tetap Yayasan','Percobaan'=>'Pegawai Percobaan','Magang'=>'Pegawai Magang','KONTRAK'=>'Kontrak'] as $val => $label)
                                                            <option value="{{ $val }}"
                                                                {{ old('kepegawaian.status_kepegawaian', $gtk->employment?->status_kepegawaian) == $val ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="tmt"
                                                           ...
                                                           value="{{ old('kepegawaian.tmt', $gtk->employment?->tmt ? \Carbon\Carbon::parse($gtk->employment->tmt)->format('Y-m-d') : '') }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="nomor_sk"
                                                           ...
                                                           value="{{ old('kepegawaian.nomor_sk', $gtk->employment?->nomor_sk) }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="tanggal_sk"
                                                           ...
                                                           value="{{ old('kepegawaian.tanggal_sk', $gtk->employment?->tanggal_sk ? \Carbon\Carbon::parse($gtk->employment->tanggal_sk)->format('Y-m-d') : '') }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="pangkat_golongan"
                                                           ...
                                                           value="{{ old('kepegawaian.pangkat_golongan', $gtk->employment?->pangkat_golongan) }}">
                                                </div>
                                                    ...
                                                    <select class="form-select" id="work_unit_id" name="work_unit_id" required>
                                                        ...
                                                        @foreach ($workUnits as $unit)
                                                            <option value="{{ $unit->id }}"
                                                                {{ old('work_unit_id', $gtk->gtkWorkUnits?->where('is_primary',true)->first()?->work_unit_id) == $unit->id ? 'selected' : '' }}>
                                                                {{ $unit->name }} ({{ $unit->code }})
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-keluarga" role="tabpanel">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div>
                                                    ...
                                                    <p class="text-muted mb-0">Kelola anggota keluarga GTK (opsional)</p>
                                                </div>
                                                <button type="button" class="btn btn-primary btn-sm"
                                            ...
                                            {{-- Pencarian pasangan GTK terdaftar --}}
                                            ...
                                            <div id="familyEmpty" class="text-center py-4 text-muted">
                                                ...
                                                <p class="mb-0">Belum ada anggota keluarga.</p>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-review" role="tabpanel">
                                            <div class="text-center pt-4 pb-2">
                                                ...
                                                <h5>Review Perubahan Data GTK</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="fm_tempat_lahir">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="fm_pekerjaan">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="fm_alamat" rows="2"></textarea>
                        </div>
                    </div>
                </div>
...
@php
    $educationData = $gtk->educations->map(function($e) {
        return [
            'id'                     => $e->id,
            ...
            'no_ijazah'              => $e->no_ijazah,
            'nilai_akhir'            => $e->nilai_akhir,
            'skala_nilai'            => $e->skala_nilai ?? '100',
            'status'                 => $e->status,
            'nama_kepala_sekolah'    => $e->nama_kepala_sekolah,
            'nama_rektor'            => $e->nama_rektor,
            'keterangan'             => $e->keterangan,
        ];
    })->values()->toArray();

    $familyData = $gtk->gtkProfile?->familyMembers?->map(function($m) {
        return [
            'id'                  => $m->id,
            ...
            'pendidikan_terakhir' => $m->pendidikan_terakhir ?? '',
            'alamat'              => $m->alamat ?? '',
            'gtk_id'              => null,
        ];
    })->values()->toArray() ?? [];
...
let educationList = @json($educationData);
let familyList    = @json($familyData);
let educationFiles = {};
let spouseGtkId    = null;
let searchTimeout  = null;

// Existing address codes for re-populating dropdowns
const existingDomisili = {
    province_code: '{{ $alamatDomisili?->province_code ?? "" }}',
    city_code:     '{{ $alamatDomisili?->city_code ?? "" }}',
    district_code: '{{ $alamatDomisili?->district_code ?? "" }}',
    village_code:  '{{ $alamatDomisili?->village_code ?? "" }}',
};
const existingKtp = {
    province_code: '{{ $alamatKtp?->province_code ?? "" }}',
    city_code:     '{{ $alamatKtp?->city_code ?? "" }}',
    district_code: '{{ $alamatKtp?->district_code ?? "" }}',
    village_code:  '{{ $alamatKtp?->village_code ?? "" }}',
};
...
/* ==========================================================================
   ...
   ========================================================================== */
async function restoreAddressDropdowns() {
    if (existingDomisili.province_code) {
        await loadCities(existingDomisili.province_code, 'kabupaten_domisili');
        var el = document.getElementById('kabupaten_domisili'); if (el) el.value = existingDomisili.city_code;

        await loadDistricts(existingDomisili.city_code, 'kecamatan_domisili');
        el = document.getElementById('kecamatan_domisili'); if (el) el.value = existingDomisili.district_code;

        await loadVillages(existingDomisili.district_code, 'desa_domisili', 'kode_pos_domisili');
        el = document.getElementById('desa_domisili'); if (el) el.value = existingDomisili.village_code;
    }

    if (existingKtp.province_code) {
        await loadCities(existingKtp.province_code, 'kabupaten_ktp');
        var el = document.getElementById('kabupaten_ktp'); if (el) el.value = existingKtp.city_code;

        await loadDistricts(existingKtp.city_code, 'kecamatan_ktp');
        el = document.getElementById('kecamatan_ktp'); if (el) el.value = existingKtp.district_code;

        await loadVillages(existingKtp.district_code, 'desa_ktp', 'kode_pos_ktp');
        el = document.getElementById('desa_ktp'); if (el) el.value = existingKtp.village_code;
    }
}
...
/* ==========================================================================
   JABATAN
   ========================================================================== */
function populateJabatan(jenisGtk, selectedJabatan) {
...
/* ==========================================================================
   WILAYAH — FIX: tambah credentials: 'same-origin' di semua fetch
   ========================================================================== */
...
async function copyAddressToKTP() {
    ...
    if (!isSame) {
        const el = document.getElementById('provinsi_ktp'); if (el) el.value = '';
...
/* ==========================================================================
   RIWAYAT PENDIDIKAN — FIX: ganti ${i] menjadi ${i}
   ========================================================================== */
        ...
        return '<div class="card border mb-3" id="edu-card-' + i + '">' +
            '<div class="card-header py-2 d-flex justify-content-between align-items-center">' +
                '<span class="fw-semibold">' +
                    ...
                    (edu.id
                        ? ' <span class="badge bg-success-subtle text-success ms-2">Tersimpan</span>'
                        : ' <span class="badge bg-warning-subtle text-warning ms-2">Baru</span>') +
                '</span>' +
            ...
            '<div class="card-body py-2">' +
                '<div class="row g-2 small text-muted">' +
                    ...
                    '<div class="col-md-4"><strong>Status:</strong> ' +
                        '<span class="badge ' + (edu.status === 'LULUS' ? 'bg-success' : 'bg-secondary') + '">' +
                            escHtml(edu.status || '-') +
                        '</span>' +
                    '</div>' +
                '</div>' +
                (edu.id ? '<input type="hidden" name="pendidikan[' + i + '][id]" value="' + escAttr(edu.id) + '">' : '') +
...
function showEducationModal(editIndex) {
    ...
    Swal.fire({
        ...
        html:
            '<div class="row g-3 text-start">' +
                ...
                '<div class="col-md-6">' +
                    ...
                    '<input class="form-control" id="edu_nama" value="' + escAttr(edu.nama_satuan_pendidikan || '') + '" placeholder="Nama institusi">' +
                '</div>' +
                '<div class="col-md-6">' +
                ...
                '<div class="col-md-6">' +
                    ...
                    '<select class="form-select" id="edu_status">' +
                        [['LULUS','Lulus'],['BELUM_LULUS','Belum Lulus'],['DROPOUT','Drop Out'],['PINDAH','Pindah']].map(function(pair) {
                            return '<option value="' + pair[0] + '" ' + ((edu.status || 'LULUS') === pair[0] ? 'selected' : '') + '>' + pair[1] + '</option>';
                        }).join('') +
                    '</select>' +
                '</div>' +
                '<div class="col-md-6">' +
                    '<label class="form-label">Kepala Sekolah / Rektor</label>' +
                ...
                '<div class="col-md-6">' +
                    ...
                    (isEdit && educationFiles[editIndex]?.ijazah
                        ? '<small class="text-success">' + escHtml(educationFiles[editIndex].ijazah.name) + '</small>'
                        : '') +
                '</div>' +
                '<div class="col-md-6">' +
                    ...
                    (isEdit && educationFiles[editIndex]?.transkrip
                        ? '<small class="text-success">' + escHtml(educationFiles[editIndex].transkrip.name) + '</small>'
                        : '') +
                '</div>' +
            '</div>',
        showCancelButton: true,
        ...
        const idx  = isEdit ? editIndex : educationList.length;
        if (isEdit && educationList[idx]?.id) data.id = educationList[idx].id;
...
/* ==========================================================================
   DATA KELUARGA — FIX: ganti ${i] menjadi ${i}
   ========================================================================== */
        ...
        return '<div class="card border mb-2">' +
            '<div class="card-body py-2 d-flex justify-content-between align-items-center">' +
                '<div>' +
                    ...
                    '<span class="text-muted small ms-2">' + escHtml(jkLabel[m.jenis_kelamin] || '-') + '</span>' +
                    (m.gtk_id ? ' <span class="badge bg-success ms-1">GTK</span>' : '') +
                    (m.id ? ' <span class="badge bg-success-subtle text-success ms-1">Tersimpan</span>' : '') +
                '</div>' +
                '<div class="d-flex gap-2">' +
...
function showAddFamilyModal(editIndex) {
    ...
    document.getElementById('familyMemberModalLabel').textContent = isEdit ? 'Edit Anggota Keluarga' : 'Tambah Anggota Keluarga';
...
async function searchGtk(query) {
    ...
    try {
        const res  = await fetch('/personalia/gtk?search=' + encodeURIComponent(query) + '&format=json', {
            credentials: 'same-origin',
        ...
        if (!list.length) {
            resultList.innerHTML = '<div class="list-group-item text-muted py-2">Tidak ada hasil.</div>';
            return;
        }
        resultList.innerHTML = list.slice(0, 8).map(function(gtk) {
            const dataStr = escAttr(JSON.stringify(gtk));
            return '<button type="button" class="list-group-item list-group-item-action py-2"' +
                ...
                '<div class="d-flex justify-content-between">' +
                    '<div><strong>' + escHtml(gtk.name || '') + '</strong>' +
                    '<small class="text-muted ms-2">' + escHtml(gtk.employment?.nupy ?? gtk.nupy ?? '') + '</small></div>' +
                    '<small class="text-muted">' + escHtml(gtk.email || '') + '</small>' +
                '</div></button>';
        }).join('');
    } catch (err) {
        resultList.innerHTML = '<div class="list-group-item text-danger py-2">Gagal mencari.</div>';
    }
}
...
function selectSpouseGtk(gtk) {
    ...
    if (existingIdx !== -1) {
        showAddFamilyModal(existingIdx);
        return;
    }
...
function clearSpouseSelection() {
    familyList = familyList.filter(function(m) { return m.gtk_id !== spouseGtkId; });
    spouseGtkId = null;
...
function showReviewData() {
    ...
    document.getElementById('reviewData').innerHTML =
        ...
        '<tbody>' +
            ...
            '<tr><th>Email</th><td>' + escHtml(v('email')) + '</td></tr>' +
            '<tr><th>NIK</th><td>' + escHtml(nikMasked) + '</td></tr>' +
            '<tr><th>No. KK</th><td>' + escHtml(v('no_kk') || '-') + '</td></tr>' +
            '<tr><th>Tempat/Tgl Lahir</th><td>' + escHtml(v('tempat_lahir')) + ' / ' + escHtml(formatDt(v('tanggal_lahir'))) + '</td></tr>' +
            ...
            '<tr><th>Status Akun</th><td>' + (document.getElementById('is_active')?.checked
                ? '<span class="badge bg-success">Aktif</span>'
                : '<span class="badge bg-danger">Nonaktif</span>') + '</td></tr>' +
            ...
            '<tr><th>NUPY</th><td>' + escHtml(vn('kepegawaian[nupy]') || '-') + '</td></tr>' +
            ...
            '<tr><th>TMT</th><td>' + escHtml(vn('kepegawaian[tmt]') ? formatDt(vn('kepegawaian[tmt]')) : '-') + '</td></tr>' +
            '<tr><th>No. SK</th><td>' + escHtml(vn('kepegawaian[nomor_sk]') || '-') + '</td></tr>' +
            '<tr><th>Tanggal SK</th><td>' + escHtml(vn('kepegawaian[tanggal_sk]') ? formatDt(vn('kepegawaian[tanggal_sk]')) : '-') + '</td></tr>' +
...
async function submitForm() {
    ...
    try {
        ...
        const gtkId   = document.querySelector('input[name="_gtk_id"]').value;
        const response = await fetch('{{ route("user.gtk.update", ["userId" => $userId, "uuid" => $gtk->id]) }}', {
            method: 'POST',
            credentials: 'same-origin',
            headers: {
        ...
        btn.disabled = false;
        btn.innerHTML = '<i class="ri-save-line label-icon align-middle fs-16 me-2"></i> Simpan Perubahan';

        if (result.success) {
            Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
                text: result.message || 'Data GTK berhasil diperbarui.',
            ...
            if (result.errors) {
                ...
                Object.values(result.errors).forEach(function(e) {
                    html += '<li>' + escHtml(e[0]) + '</li>';
                });
                html += '</ul>';
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal!',
                    html: escHtml(result.message) +
                        (result.exception
                            ? '<br><small class="text-muted">' + escHtml(result.exception) +
                              (result.line ? ' (line ' + result.line + ')' : '') + '</small>'
                            : '')
                });
            }
        }
