...
@section('content')
    ...
    <form method="POST"
          action="{{ route('user.students.mahroms.globalUpdate', ['userId' => $userId, 'mahromUuid' => $mahrom->id]) }}"
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="ri-user-card-line me-2 text-primary"></i>Santri Terkait</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <select name="student_id" id="studentSelect" class="form-select" required>
                            ...
                            @foreach($students as $s)
                                ...
                                <option value="{{ $s->id }}"
                                        ...
                                        {{ (string) old('student_id', $mahrom->student_id) === (string) $s->id ? 'selected' : '' }}>
                        ...
                        <div class="form-text text-muted">
                            Ketik untuk mencari nama, NISN, NIK, kelas, atau nama kamar Santri. Pindahkan mahrom ke Santri lain bila perlu.
                        </div>
                        @error('student_id')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="fw-semibold">
                                {{ ucfirst(str_replace('_', ' ', $mahrom->relationship)) }}
                            </div>
                        </div>
                        <div class="mb-3">
