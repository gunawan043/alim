...
@section('content')
    ...
    <form method="POST" action="{{ route('user.asrama.wings.store', ['userId' => $userId, 'asramaUuid' => $dormitory->id]) }}">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header"><h5 class="mb-0">Form Gedung Asrama</h5></div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">Kode Gedung <span class="text-danger">*</span></label>
                                <input type="text" name="code" class="form-control" value="{{ old('code') }}" required placeholder="A" maxlength="20">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Nama Gedung <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="Gedung A — Lantai 1" maxlength="100">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="capacity" class="form-control" value="{{ old('capacity') }}" min="0" placeholder="0">
                            </div>
                            <div class="col-md-4">
