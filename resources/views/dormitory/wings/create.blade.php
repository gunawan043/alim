...
@section('content')
    ...
    <form method="POST" action="{{ route('user.asrama.wings.store', ['userId' => $userId, 'asramaUuid' => $dormitory->id]) }}">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header"><h5 class="mb-0"><i class="ri-building-line me-1" aria-hidden="true"></i> Form Gedung Asrama</h5></div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="wing_code" class="form-label">Kode Gedung <span class="text-danger">*</span></label>
                                <input type="text" name="code" id="wing_code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" required placeholder="A" maxlength="20">
                                @error('code')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                                <label for="wing_name" class="form-label">Nama Gedung <span class="text-danger">*</span></label>
                                <input type="text" name="name" id="wing_name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Gedung A — Lantai 1" maxlength="100">
                                @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-4">
                                <label for="wing_floor" class="form-label">Lantai</label>
                                <input type="number" name="floor" id="wing_floor" class="form-control @error('floor') is-invalid @enderror" value="{{ old('floor') }}" min="0" placeholder="1">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-2">
                                    ...
                                    <label class="form-check-label" for="wing_is_active">Gedung aktif</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary" aria-label="Simpan gedung baru">
