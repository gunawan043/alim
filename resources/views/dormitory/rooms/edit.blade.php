                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="code" class="form-control" value="{{ old('code', $room->code) }}" required maxlength="20">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Nama Kamar</label>
                                <input type="text" name="name" class="form-control" value="{{ old('name', $room->name) }}" maxlength="100">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="floor" class="form-control" value="{{ old('floor', $room->floor) }}" min="0">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="facility_notes" class="form-control" rows="2">{{ old('facility_notes', $room->facility_notes) }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1" {{ old('is_active', $room->is_active) ? 'checked' : '' }}>
