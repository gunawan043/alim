...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') Daftar Tingkat Kelas @endslot
    @endcomponent
            ...
            <div class="card">
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <h5 class="card-title mb-0">Tingkat Kelas</h5>
                            <p class="text-muted mb-0">Pengaturan tingkat/jenjang kelas @if(!$isGlobalView)di sekolah Anda.{{-- scoped --}} @else {{-- global --}}per sekolah.@endif</p>
                        </div>
                ...
                <div class="card-body">
                    <form method="GET" class="row g-3 mb-4">
                        ...
                        @endif
                        <div class="{{ $isGlobalView ? 'col-md-4' : 'col-md-6' }}">
                        ...
                        <table class="table table-nowrap align-middle">
                            ...
                            <tbody>
                                @forelse($gradeLevels as $gl)
                                    <tr>
                                        <td>{{ $loop->iteration + ($gradeLevels->currentPage() - 1) * $gradeLevels->perPage() }}</td>
                                        @if($isGlobalView)
                                        <td>
                                            <a href="{{ route('user.schools.show', ['userId' => $userId, 'schoolId' => $gl->school_id]) }}" class="fw-medium link-primary">
                                                {{ $gl->school?->name ?? '-' }}
                                            </a>
                                        </td>
                                        @endif
