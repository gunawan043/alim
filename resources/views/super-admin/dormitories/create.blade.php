        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom-dashed">
                    <h5 class="card-title mb-0">添加新宿舍</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('user.sa.dormitories.store', ['userId' => $userId]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="code" class="form-control" placeholder="自动编号">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">性别 <span class="text-danger">*</span></label>
                                <select name="gender" class="form-select" required>
                                    <option value="">选择...</option>
                                    <option value="putra">男宿</option>
                                    <option value="putri">女宿</option>
                                    <option value="campuran">混合</option>
                                </select>
                            </div>
                            <div class="col-md-4">
