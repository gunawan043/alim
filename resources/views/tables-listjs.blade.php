                            ...
                            <table class="table align-middle table-nowrap" id="customerTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="no_hp">Phone</th>
                                ...
                                <tbody class="list form-check-all">
                                    <tr>
                                        ...
                                        <td class="email">marycousar@Alim.com</td>
                                        <td class="no_hp">580-464-4694</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="customer_name">AMary Cousar</td>
                                        <td class="email">amarycousar@Alim.com</td>
                                        <td class="no_hp">580-3464-4694</td>
                                        <td class="date">06 Apr, 2021</td>
                                        <td class="status"><span
                                                class="badge bg-success-subtle text-success text-uppercase">Active</span>
                                        </td>
            ...
            <div class="modal-content">
                ...
                <form class="tablelist-form" autocomplete="off">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="no_hp-field" class="form-label">Phone</label>
                            <input type="text" id="no_hp-field" class="form-control" placeholder="Enter Phone no."
                                required />
                            <div class="invalid-feedback">Please enter a no_hp.</div>
                        </div>
