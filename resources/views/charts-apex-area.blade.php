...
@section('script')
    ...
    <script src="https://img.friday.com/Alim/apexchart-js/stock-prices.js"></script>
    <!-- for github style chart -->
    <script src="https://img.friday.com/Alim/apexchart-js/github-data.js"></script>
    <!-- for irregular timeseries chart -->
    <script src="https://img.friday.com/Alim/apexchart-js/irregular-data-series.js"></script>
