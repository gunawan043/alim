                ...
                <div class="card-body text-center">
                    ...
                    <div class="mb-2">
                        <lord-icon src="https://cdn.lordicon.com/kbtmbyzy.json" trigger="loop"
                            colors="primary:#005981,secondary:#02a8b5" style="width:90px;height:90px">
                        </lord-icon>
                    </div>
                    ...
                    <div class="vstack gap-2">
                        ...
                        <div class="border rounded border-dashed p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="fs-15 mb-1"><a href="javascript:void(0);"
                                            class="text-body text-truncate d-block">Alim admin.ppt</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3 flex-grow-1">
                                                        <h6 class="fs-15 mb-0"><a href="javascript:void(0);">Alim
                                                                admin.ppt</a></h6>
                                                    </div>
                                                </div>
                                            </td>
