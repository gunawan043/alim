                ...
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            ...
                            <p class="text-muted mb-0">Rekapitulasi absensi per semester per rombel (format Excel).</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5 text-muted">
                            <i class="ri-file-chart-2-line fs-1 text-secondary mb-2 d-block"></i>
