...
@section('title') Detail Sekolah @endsection
@section('css')
    <style>
...
@section('content')
                ...
                <div class="col">
                    ...
                    <div class="mt-2 text-muted small">
                        ...
                        @if($school->principalUser?->name)
                            <span><i class="ri-user-star-line me-1"></i>KSP: {{ $school->principalUser->name }}</span>
                        @elseif($school->principal_name)
                            <span><i class="ri-user-star-line me-1"></i>KSP: {{ $school->principal_name }}</span>
                        @endif
                    </div>
                </div>
                <div class="col-auto d-flex gap-2">
                    @if(auth()->user()->hasRole(['Super Admin', 'Administrator', 'Admin Tata Usaha']))
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            ...
            <div class="card info-card-profile">
                <div class="card-header">
                    <h5 class="mb-0"><i class="ri-file-text-line me-2 text-primary"></i>Kop Sekolah
    ...
    <div class="mt-3">
        ...
        <button class="btn btn-light text-danger float-end delete-school" data-id="{{ $school->id }}" data-name="{{ $school->name }}">
            <i class="ri-delete-bin-line me-1"></i> Hapus Sekolah
        </button>
        @endif
    </div>
