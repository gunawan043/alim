...
<li class="nav-item">
    <a class="nav-link menu-link{{ isActiveAsr($currentRoute, 'user.asrama.wings.') ? ' active' : '' }}"
       href="{{ $hasAsramaContext ? route('user.asrama.wings.index', ['userId' => $userId, 'asramaUuid' => $asramaUuid]) : route('user.asrama.my-profile', ['userId' => $userId]) }}">
...
<li class="nav-item">
    <a class="nav-link menu-link{{ isActiveAsr($currentRoute, 'user.asrama.reports.') ? ' active' : '' }}"
       href="{{ $hasAsramaContext ? route('user.asrama.reports.index', ['userId' => $userId, 'asramaUuid' => $asramaUuid]) : route('user.asrama.my-profile', ['userId' => $userId]) }}">
