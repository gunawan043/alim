...
<li class="menu-title"><span>UKS & Kesehatan</span></li>
...
{{-- Kalender Kepulangan (pantau izin pulang, untuk screening kesehatan saat kembali) --}}
<li class="nav-item">
...
{{-- (Modul kesehatan mungkin belum ada route; tampilkan placeholder dashboard) --}}
...
<li class="nav-item">
    <a class="nav-link menu-link{{ isActiveAsr($currentRoute, 'user.asrama.reports.') ? ' active' : '' }}"
       href="{{ $hasAsramaContext ? route('user.asrama.reports.index', ['userId' => $userId, 'asramaUuid' => $asramaUuid]) : $asramaProfileFallback }}">
        ...
        <span>Laporan Medis / Asrama</span>
    </a>
</li>
