...
<li class="nav-item">
    <a class="nav-link menu-link{{ $hasAsramaContext && isActiveAsr($currentRoute, 'user.asrama.wings.') ? ' active' : '' }}"
...
<li class="nav-item">
    <a class="nav-link menu-link{{ $hasAsramaContext && isActiveAsr($currentRoute, 'user.asrama.residents.') ? ' active' : '' }}"
...
<li class="nav-item">
    <a class="nav-link menu-link{{ $hasAsramaContext && isActiveAsr($currentRoute, 'user.asrama.inventories.') ? ' active' : '' }}"
...
<li class="menu-title"><span>Approval Center</span></li>
<li class="nav-item">
