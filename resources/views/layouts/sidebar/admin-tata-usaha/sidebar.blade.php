<!-- Admin Tata Usaha Sidebar — Admin TU, Tata Usaha, Administrator -->
@php
...
<li class="nav-item">
    ...
    <div class="collapse menu-dropdown" id="sumatif">
        <ul class="nav nav-sm flex-column">
            <li class="nav-item">
                <a class="nav-link{{ isActiveTU($currentRoute, 'user.kisi-kisi-soal.') ? ' active' : '' }}"
                   href="{{ route('user.kisi-kisi-soal.index', ['userId' => $userId]) }}"
                   style="font-size:0.85rem">Kisi-Kisi Soal</a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ isActiveTU($currentRoute, 'user.bank-soal.') ? ' active' : '' }}"
                   href="{{ route('user.bank-soal.index', ['userId' => $userId]) }}"
                   style="font-size:0.85rem">Bank Soal</a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ isActiveTU($currentRoute, 'user.paket-soal.') ? ' active' : '' }}"
...
<li class="nav-item">
    <a class="nav-link menu-link{{ isActiveTU($currentRoute, 'user.ekstrakurikuler.') || isActiveTU($currentRoute, 'ekstrakurikuler.') ? ' active' : '' }}" href="{{ route('user.ekstrakurikuler.index', ['userId' => $userId]) }}">
        <i class="ri-basketball-line"></i>
        <span>Ekstrakurikuler</span>
    </a>
</li>

@include('layouts.sidebar.uks.sidebar', ['isActiveFn' => 'isActiveTU'])
...
<li class="nav-item">
    ...
    <div class="collapse menu-dropdown" id="surat_menyurat">
        <ul class="nav nav-sm flex-column">
            <li class="nav-item"><a class="nav-link{{ isActiveTU($currentRoute, 'user.surat-keluar.') ? ' active' : '' }}" href="{{ route('user.surat-keluar.index', ['userId' => $userId]) }}" style="font-size:0.85rem">Surat Keluar</a></li>
            <li class="nav-item"><a class="nav-link{{ isActiveTU($currentRoute, 'user.surat-masuk.') ? ' active' : '' }}" href="{{ route('user.surat-masuk.index', ['userId' => $userId]) }}" style="font-size:0.85rem">Surat Masuk</a></li>
        </ul>
    </div>
</li>
<li class="nav-item">
...
@include('layouts.sidebar.sarpras.sidebar', ['isActiveFn' => 'isActiveTU'])
<li class="nav-item">
