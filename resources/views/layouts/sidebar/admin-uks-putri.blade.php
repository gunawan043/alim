<!-- Admin UKS Putri Sidebar — Hanya GTK Putri -->
@php
...
<li class="menu-title"><span>Status Perawatan</span></li>
<li class="nav-item">
    <a class="nav-link menu-link{{ isActiveUks($currentRoute, 'user.uks.treatment-status') || isActiveUks($currentRoute, 'user.uks.patients') ? ' active' : '' }}"
       href="{{ route('user.uks.patients.index', ['userId' => $userId, 'status' => 'rawat_uks']) }}">
        <i class="ri-heart-pulse-fill"></i>
        <span>Status Perawatan UKS</span>
    </a>
</li>
