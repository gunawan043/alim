        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-height-100">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0"><i class="ri-building-line align-bottom"></i> friday <span
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1">
                                                <label class="form-check-label mb-0 ps-2" for="task_six">Styling wireframe
                                                    design and
                                                    documentation for Alim admin</label>
                                            </div>
                                            <div class="flex-shrink-0 ms-2">
                                                <p class="text-muted fs-13 mb-0">27 Sep, 2021</p>
                                            </div>
                    ...
                    <div class="notification-elem" id="notification-overlay">
                        <div class="text-center">
                            <lord-icon src="https://cdn.lordicon.com/lupuorrc.json" trigger="loop"
                                colors="primary:#0ab39c,secondary:#005981" style="width:120px;height:120px"></lord-icon>
                            <div class="mt-4 pt-2">
