                ...
                <div class="card-body p-4">
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="all" role="tabpanel">
                            <div class="pb-3">
                                <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Alim - Responsive Bootstrap 5
                                        Admin Dashboard</a></h5>
                                <p class="text-success mb-2">https://friday.com/Alim/index.html</p>
                                <p class="text-muted mb-2">Alim admin is super flexible, powerful, clean, modern &
                                    ...
                                    design in your existing project using Alim it is very quick and easy as it is
                                    ...
                                    <li class="list-inline-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 fs-13 ms-1">
                                                <span class="fw-medium">friday</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="py-3">
                                <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Skote - Academic Learning & Information Management
                                        by friday</a></h5>
                                <p class="text-success mb-2">https://friday.com/skote/</p>
                            ...
                            <div class="py-3">
                                <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Minia - React Js Admin & Dashboard
                                        Template</a></h5>
                                <p class="text-success mb-2">https://friday.com/minia/react/</p>
                            ...
                            <div class="py-3">
                                <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Doson - Angular Admin & Dashboard
                                        Template by friday</a></h5>
                                <p class="text-success mb-2">https://friday.com/dason/angular/</p>
                                ...
                                <div class="col-lg-12 video-list">
                                    <div class="list-element">
                                        <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Admin dashboard templates
                                                - Material Design for Alim</a></h5>
                                        <p class="text-success">https://friday.com/Alim/index.html</p>
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex-grow-1 ms-sm-3 mt-2 mt-sm-0">
                                                <p class="text-muted mb-0">Alim admin is super flexible, powerful, clean,
                                                    ...
                                                    large projects or update design in your existing project using Alim it
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Alim - The Most Popular
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Alim Admin Dashboard
