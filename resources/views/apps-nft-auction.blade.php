    ...
    <div class="col-xxl-9">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="https://img.friday.com/Alim/images/img-1.gif" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="https://img.friday.com/Alim/images/img-5.gif" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.friday.com/Alim/images/img-4.gif" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.friday.com/Alim/images/img-3.gif" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
